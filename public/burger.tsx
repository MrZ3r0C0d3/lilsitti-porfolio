...
export default function Burger() {
	...
	const [topFillColor, setTopFillColor] = useState('#EAE2D7');
	const [bottomFillColor, setBottomFillColor] = useState('#EAE2D7');
	const [tomatoFillColor, setTomatoFillColor] = useState('#EAE2D7');
	const [saladeFillColor, setSaladeFillColor] = useState('#EAE2D7');
	const [cheeseFillColor, setCheeseFillColor] = useState('#EAE2D7');
	const [pattyFillColor, setPattyFillColor] = useState('#EAE2D7');

	const handleTopClick = () => {
		setTopFillColor('#F4C064');
		setBottomFillColor('#EAE2D7');
		setTomatoFillColor('#EAE2D7');
		setSaladeFillColor('#EAE2D7');
		setCheeseFillColor('#EAE2D7');
		setPattyFillColor('#EAE2D7');
	};
	const handleBottomClick = () => {
		setBottomFillColor('#F4C064');
		setTopFillColor('#EAE2D7');
		setTomatoFillColor('#EAE2D7');
		setSaladeFillColor('#EAE2D7');
		setCheeseFillColor('#EAE2D7');
		setPattyFillColor('#EAE2D7');
	...
	const handleMiddleClick = () => {
		setTomatoFillColor('#FF603E');
		setSaladeFillColor('#91F18B');
		setCheeseFillColor('#FFE954');
		setPattyFillColor('#99774F');
		setBottomFillColor('#EAE2D7');
		setTopFillColor('#EAE2D7');
	...
	return (
		<svg className="mx-auto" width="376" height="366" viewBox="0 0 376 366" fill="none" xmlns="http://www.w3.org/2000/svg">
			<g id="burger_icon">
				<g id="bottom_part" onClick={handleBottomClick} fill={bottomFillColor}>
