...
export default function HomeAboutMe(){
    return(
        <div>
            ...
            <img src="" alt="animation_img" />
            <p>Now, here&apos;s a glimpse of my <span className="bodoni-moda-italic-uppercase">tech stack</span><br/>
                served up like a <span className="bodoni-moda-italic-uppercase">tempting burger</span></p>
            <img src="" alt="bruger" />
        </div>
    )
}